 ...
 * @see Zend_Config
 */
require_once app_path().'/libraries/Zend/Config.php';
...
class Zend_Config_Ini extends Zend_Config
{
    ...
    public function __construct($filename, $section = null, $options = false)
    {
        if (empty($filename)) {
             ...
             */
            require_once app_path().'/libraries/Zend/Config/Exception.php';
    ...
    protected function _parseIniFile($filename)
    {
        ...
        $iniArray = parse_ini_file(app_path()."/libraries/".$filename, true); // Warnings and errors are suppressed
