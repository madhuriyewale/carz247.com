                    ...
                    <li>
                        ...
                        <ul class="menu">
                            ...
                            <li>
                                <a href="#">
                                    <div class="pull-left">
                                        {{ HTML::image('public/admin/img/avatar.png') }}
                                    </div>
                                    <h4>
                                        Developers
                            ...
                            <li>
                                <a href="#">
                                    <div class="pull-left">
                                        {{ HTML::image('public/admin/img/avatar2.png' ,'', array('class' => 'img-circle')) }} 
                                    </div>
                                    <h4>
                                        Sales Department
                            ...
                            <li>
                                <a href="#">
                                    <div class="pull-left">
                                        {{ HTML::image('public/admin/img/avatar.png' ,'', array('class' => 'img-circle')) }}
                                    </div>
                                    <h4>
                                        Reviewers
