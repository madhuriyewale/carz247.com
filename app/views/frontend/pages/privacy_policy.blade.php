...
<div id="middle" class="full_width">
    <div class="container clearfix">  
       ...
       <div class="entry">
                ...
                <p class="jstfy">We value the trust you place in us. That's why we insist upon the highest standards for secure transactions and customer information privacy. Please read the following statement to learn about our information gathering and dissemination practices.</p>
                
                
                
                <h2>Note</h2>
                
                <p class="jstfy">Our privacy policy is subject to change at any time without notice. To make sure you are aware of any changes, please review this policy periodically.<br>
...
By mere use of the Website, you expressly consent to our use and disclosure of your personal information in accordance with this Privacy Policy. This Privacy Policy is incorporated into and subject to the Terms of Use.</p>
				...
				<ol>
                	<li class="mt20"> <h4 class="mt30">Collection of Personally Identifiable Information and other Information</h4>
...
We collect personally identifiable information (email address, name, phone number, credit card / debit card / other payment instrument details, etc.) from you when you set up a free account with us. While you can browse some sections of our Website without being a registered member, certain activities (such as placing an order) do require registration. We do use your contact information to send you offers based on your previous orders and your interests.<br>
                	...
                	<li><h4 class="mt30">Use of Demographic / Profile Data / Your Information</h4>
...
income level). We use this data to tailor your experience at our Website, providing you with content that we think you might be interested in and to display content according to your preferences.<br>
                	...
                	<li>
                    <h4 class="mt30">Sharing of personal information</h4>
...
We and our affiliates will share / sell some or all of your personal information with another business entity should we (or our assets) plan to merge with, or be acquired by that business entity, or re-organization, amalgamation, restructuring of business. Should such a transaction occur that other business entity (or the new combined entity) will be required to follow this privacy policy with respect to your personal information.<br>
                   ...
                   <li>
                    <h4 class="mt30">Links to Other Sites</h4>
                    	Our Website links to other websites that may collect personally identifiable information about you. CARZ247.com is not responsible for the privacy practices or the content of those linked websites.
                    </li>

                   <li>
                    <h4 class="mt30">Security Precautions</h4>
                    	Our Website has stringent security measures in place to protect the loss, misuse, and alteration of the information under our control. Whenever you change or access your account information, we offer the use of a secure server. Once your information is in our possession we adhere to strict security guidelines, protecting it against unauthorized access.
                    </li>

                   <li>
                    <h4 class="mt30">Choice/Opt-Out</h4>
                    	We provide all users with the opportunity to opt-out of receiving non-essential (promotional, marketing-related) communications from us on behalf of our partners, and from us in general, after setting up an account.<br>
If you want to remove your contact information from all CARZ247.com lists and newsletters, please visit http://www.CARZ247.com/unsubscribe.php

                    </li>

                   <li>
                    <h4 class="mt30">Advertisements on CARZ247.com</h4>
...
If we decide to change our privacy policy, we will post those changes on this page so that you are always aware of what information we collect, how we use it, and under what circumstances we disclose it.
                   ...
                   <li>
                    <h4 class="mt30">Grievance Officer</h4>
                ...
                <div class="box_content clearfix">                	
                	<div class="left_side contact-address">
	                	<div class="name"><strong>Mr Parin Thaker</strong></div>
						<div class="address">CARZ247 Solutions Private Limited</div>
						
                        <div class="row phone"><em>Phone:</em> <span>+91- 7666 947 247</span></div>	                    
		                <div class="row mail"><em>Email:</em> <a href="mailto:parin@infiniteit.biz" hidefocus="true" style="outline-style: none; outline-width: initial; outline-color: initial; ">parin@infiniteit.biz</a></div>
                        <div class="row fax"><em>Time:</em> <span>Mon - Fri (9:00 - 18:00)</span></div>
                   ...
                   <li>
                    <h4 class="mt30">Questions?</h4>
                    	Questions regarding this statement should be directed to the following address: <a href="mailto:bookings@CARZ247.com" hidefocus="true" style="outline-style: none; outline-width: initial; outline-color: initial; ">bookings@carz247.com</a>
                    </li>
