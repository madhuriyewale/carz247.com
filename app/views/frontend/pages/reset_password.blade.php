                    ...
                    <div class="widget-container widget_login">
                        ...
                        <form class="loginform" method="post" action="{{URL::route('check_reset_password')}}">
                           <input type="hidden"  value="{{ $email }}"  name="email"></p>								
                            ...
                            <p><label>New Password</label><br><input type="password" tabindex="20" size="20"  class="input validate[required,minSize[6]] text-input" id="password" name="newPassword"></p>								
                            <p><label>Confirm Password</label><br><input type="password" tabindex="20" size="20" class="input validate[required,minSize[6]] text-input" id="cpass" name="newConfirmPassword"></p>								
