                ...
                <form name="change_password" action="{{ URL::route('check_change_password') }}" method="post" class="loginform">
                    ...
                    <div class="col col_1_2 alpha">
                        ...
                        <div class="widget-container">
                            ...
                            <div class="padding15">
                                ...
                                <p><label>Current password</label><br> <input type="password" name="currentPassword" id="current" class="input w_100"></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col col_1_2 alpha">
                        <div class="widget-container">
                            ...
                            <div class="padding15">
                                <p><label>New password</label><br><input type="password" name="newPassword" id="password" class="input w_100"></p>
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"></div>	
                    ...
                    <div class="col col_1_2 alpha">
                        <div class="widget-container">
                            <div class="padding15">
                                <p><label>Confirm password</label><br><input type="password" name="NewConfirmPassword" id="cpass" class="input w_100"></p>	
                            </div>
                        </div>
                    </div>
