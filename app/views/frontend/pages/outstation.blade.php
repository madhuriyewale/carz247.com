    ...
    <div class="container clearfix">  
        ...
        <div class="content">
            <div class="title2">
                ...
                @else 
                <h2 class="manage_title">You are looking for {{ @$listings[0]['service'] }} Car  usage from {{ @$listings[0]['city'] }} to {{ @Session::get('toCity') }} for the dates {{ Session::get('fromDate') }} to {{ Session::get('toDate') }}</h2>	
                ...
                <div class="col col_2_3  omega">
                    <div class="search_aisde">
                        <div class="search_title">
                            ...
                            <div class="alignright">Base Cost :   <i class="fa fa-inr"></i> {{ number_format($listing['min_kms'] * $listing['extra_km_cost'] * $days + $days*$listing['driver_cost']) }}</div>
                        </div>
                        ...
                        <div class="search_book">
                            ...
                            <div id="details-{{ $listing['id'] }}" style="display:none;" class="mt30">
                                ...
                                <div>
                                    <div><h3 class="widget-title">Base Cost: <i class="fa fa-inr"></i>{{ number_format($listing['min_kms'] * $listing['extra_km_cost'] * $days + $days*$listing['driver_cost']) }}</h3> </div>
                                    <div class="styled_table table_dark">
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td> <div class="booking_sum"><span>Kilometers: </span>{{ $listing['min_kms'] * $days }} Kms</div></td>
                                                    <td> <div class="booking_sum"><span>Service Tax, Toll, Parking  </span> </div></td>
                                                </tr>
                                                <tr class="odd">
                                                    <td> <div class="booking_sum"><span>Chauffeur Charges</span></div></td>
                                                    <td><div class="booking_sum"><span>Extra Km. beyond {{ $listing['min_kms']* $days }} Kms: </span> <i class="fa fa-inr"></i> {{ $listing['extra_km_cost'] }} per Km.</div></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
